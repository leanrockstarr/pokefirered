...
const u8 gMoveDescription_AquaTail[] = _("Tnull");
const u8 gMoveDescription_BraveBird[] = _("null");
const u8 gMoveDescription_BugBuzz[] = _("null");
const u8 gMoveDescription_BulletPunch[] = _("null");
const u8 gMoveDescription_DarkPulse[] = _("null");
const u8 gMoveDescription_DragonPulse[] = _("null");
const u8 gMoveDescription_DrainPunch[] = _("null");
const u8 gMoveDescription_EarthPower[] = _("null");
const u8 gMoveDescription_EnergyBall[] = _("null");
const u8 gMoveDescription_FlashCannon[] = _("null");
